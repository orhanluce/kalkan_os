...
outbox olayı. **688 birim + 26 e2e.** Sıradaki: PR-2b (dayanak türü + control
pack) → PR-2c (plan/entitlement + server-side zorlama) → CFO MVP → Regulated
dikey dilim. **BORÇ:** PGlite test kurulumu 50+ migration'ı her dosyada
