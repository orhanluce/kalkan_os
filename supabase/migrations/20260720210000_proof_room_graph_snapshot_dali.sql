-- Dikey D, ilk dilim (ADR §4): Proof Room'a etki grafi anlık görüntüsü dalı.
-- GÜNCEL proof_room_goruntule temel alındı (grep doğrulandı: 20260720180000
-- en son sürüm) — Faz 4'ün dersinin BİR KEZ DAHA uygulanması.
--
-- MİNİMİZASYON GEREKMEZ (assurance_claims/roi_export'tan FARK): graf
-- düğümleri yalnız kimlik/ad/tur taşır, ham gerekçe/iddia metni YOK —
-- tamamı döner.
