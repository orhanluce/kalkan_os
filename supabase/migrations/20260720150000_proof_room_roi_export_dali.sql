-- 37 Tez Dikey B, Faz 3 kalan dilimi (20 Temmuz 2026, docs/adr/PR0-37-tez-
-- dikeyB-faz3-kalan-2026-07-20.md §5): Proof Room'a roi_export_run_id dalı
-- eklenir. test_run_id dalı DOKUNULMADI (20260718220000) — CREATE OR
-- REPLACE ile aynı fonksiyona bir dal eklendi (şiplenmiş migration
-- DEĞİŞTİRİLMEDİ, forward-fix deseni).
--
-- YALNIZ durum='YAYINLANDI' export'lar açılabilir — bu zaten roi_export_
-- runs guard'ının (20260720130000) "engelleyici sorun varken YAYINLANDI
-- olamaz" invariant'ıyla export öncesi engellemeyi Proof Room seviyesinde
-- de garanti eder (ADR §4: ayrı bir kontrol GEREKMEZ, yapısal).
